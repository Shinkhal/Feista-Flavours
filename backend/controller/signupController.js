...
export const sendUser = async (req, res, next) => {
  ...
  try {
    ...
    const emailSubject = "Welcome to Feista Flavours Cuisine!";
    ...
    Welcome to Feista Flavours Cuisine! We're thrilled to have you join us. Get ready to embark on a culinary journey filled with delicious flavors and delightful dishes.
